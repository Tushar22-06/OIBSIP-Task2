...
public class UnitTimeDataProvider {
    ...
    static {
        ...
        addItem(new DataItemUnits("unit_time_month", R.string.string_units_list_time_month, "[ mm ]", "quantities_time", "ic_quantities_time.png"));
        addItem(new DataItemUnits("unit_time_week", R.string.string_units_list_time_week, "[ W ]", "quantities_time", "ic_quantities_time.png"));
        addItem(new DataItemUnits("unit_time_day", R.string.string_units_list_time_day, "[ dd ]", "quantities_time", "ic_quantities_time.png"));
        addItem(new DataItemUnits("unit_time_hour", R.string.string_units_list_time_hour, "[ h ]", "quantities_time", "ic_quantities_time.png"));
