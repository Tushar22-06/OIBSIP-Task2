...
public class UnitPowerDataProvider {
    ...
    static {
        ...
        addItem(new DataItemUnits("unit_power_watt", R.string.string_units_list_power_watt, "[ W ]", "quantities_power", "ic_quantities_power.png"));
        ...
        addItem(new DataItemUnits("unit_power_ftlbfpersecond", R.string.string_units_list_power_ftlbfpersecond, "[ ft-lbf/s ]", "quantities_power", "ic_quantities_power.png"));
        addItem(new DataItemUnits("unit_power_caloriepersecond", R.string.string_units_list_power_caloriepersecond, "[ cal/s ]", "quantities_power", "ic_quantities_power.png"));
        addItem(new DataItemUnits("unit_power_btupersecond", R.string.string_units_list_power_btupersecond, "[ btu/s ]", "quantities_power", "ic_quantities_power.png"));
        addItem(new DataItemUnits("unit_power_kvag", R.string.string_units_list_power_kva, "[ kV-A ]", "quantities_power", "ic_quantities_power.png"));
    }
